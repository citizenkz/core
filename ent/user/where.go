...
func HasUserFilters() predicate.User {
...
func HasUserFiltersWith(preds ...predicate.UserFilter) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasChildrenWith(preds ...predicate.Child) predicate.User {
	return predicate.User(func(s *sql.Selector) {
