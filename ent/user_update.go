...
func (_u *UserUpdate) SetBirthDate(v time.Time) *UserUpdate {
	_u.mutation.SetBirthDate(v)
	return _u
}

// SetNillableBirthDate sets the "birth_date" field if the given value is not nil.
func (_u *UserUpdate) SetNillableBirthDate(v *time.Time) *UserUpdate {
	if v != nil {
		_u.SetBirthDate(*v)
	}
	return _u
...
func (_u *UserUpdate) AddChildren(v ...*Child) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) RemoveChildren(v ...*Child) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// SetBirthDate sets the "birth_date" field.
func (_u *UserUpdateOne) SetBirthDate(v time.Time) *UserUpdateOne {
	_u.mutation.SetBirthDate(v)
	return _u
}

// SetNillableBirthDate sets the "birth_date" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableBirthDate(v *time.Time) *UserUpdateOne {
	if v != nil {
		_u.SetBirthDate(*v)
	}
	return _u
...
// AddChildren adds the "children" edges to the Child entity.
func (_u *UserUpdateOne) AddChildren(v ...*Child) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveChildren removes "children" edges to Child entities.
func (_u *UserUpdateOne) RemoveChildren(v ...*Child) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
