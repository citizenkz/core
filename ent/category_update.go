...
func (_u *CategoryUpdate) AddBenefitCategoryIDs(ids ...int) *CategoryUpdate {
...
func (_u *CategoryUpdate) AddBenefitCategories(v ...*BenefitCategory) *CategoryUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *CategoryUpdate) ClearBenefitCategories() *CategoryUpdate {
...
func (_u *CategoryUpdate) RemoveBenefitCategoryIDs(ids ...int) *CategoryUpdate {
...
func (_u *CategoryUpdate) RemoveBenefitCategories(v ...*BenefitCategory) *CategoryUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.BenefitCategoriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.BenefitCategoriesTable,
			Columns: []string{category.BenefitCategoriesColumn},
			Bidi:    false,
...
// AddBenefitCategoryIDs adds the "benefit_categories" edge to the BenefitCategory entity by IDs.
func (_u *CategoryUpdateOne) AddBenefitCategoryIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.AddBenefitCategoryIDs(ids...)
	return _u
}

// AddBenefitCategories adds the "benefit_categories" edges to the BenefitCategory entity.
func (_u *CategoryUpdateOne) AddBenefitCategories(v ...*BenefitCategory) *CategoryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearBenefitCategories clears all "benefit_categories" edges to the BenefitCategory entity.
func (_u *CategoryUpdateOne) ClearBenefitCategories() *CategoryUpdateOne {
	_u.mutation.ClearBenefitCategories()
	return _u
}

// RemoveBenefitCategoryIDs removes the "benefit_categories" edge to BenefitCategory entities by IDs.
func (_u *CategoryUpdateOne) RemoveBenefitCategoryIDs(ids ...int) *CategoryUpdateOne {
	_u.mutation.RemoveBenefitCategoryIDs(ids...)
	return _u
}

// RemoveBenefitCategories removes "benefit_categories" edges to BenefitCategory entities.
func (_u *CategoryUpdateOne) RemoveBenefitCategories(v ...*BenefitCategory) *CategoryUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
