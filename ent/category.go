...
func (e CategoryEdges) BenefitCategoriesOrErr() ([]*BenefitCategory, error) {
	if e.loadedTypes[0] {
...
// QueryBenefitCategories queries the "benefit_categories" edge of the Category entity.
func (_m *Category) QueryBenefitCategories() *BenefitCategoryQuery {
	return NewCategoryClient(_m.config).QueryBenefitCategories(_m)
}
